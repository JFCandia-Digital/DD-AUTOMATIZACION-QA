...
/**
 * Retorna una fecha formateada como "dd-MM-yyyy HH:mm:ss" con un offset de días hacia atrás.
 * @param diasAtras Número de días a restar de la fecha actual (1 = ayer, 2 = anteayer, etc.)
 */
export function obtenerFechaConOffset(diasAtras: number): string {
  const date = new Date();
