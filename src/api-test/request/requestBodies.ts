...
const JSON_DV_SRING_A_NUMBER = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, 1);
const JSON_DV_SRING_A_STRING_CARACTER_ESPECIAL = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, "#//´,¨.");
const JSON_DV_SRING_A_BOOLEAN = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, true);
const JSON_DV_SRING_A_ARRAY_VACIO = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, []);
const JSON_DV_SRING_A_ARRAY_CON_DATO = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, [1]);
const JSON_DV_SRING_A_OBJECT = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, {});
const JSON_DV_SRING_A_OBJECT_CON_DATO = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_USUARIO_DV, { dv: 1 });
...
// const JSON_FECHA_HORA_DE_SRING_A_NUMBER = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, 1);
// const JSON_FECHA_HORA_DE_SRING_A_STRING_CARACTER_ESPECIAL = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, "#//´,¨.");
// const JSON_FECHA_HORA_DE_SRING_A_BOOLEAN = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, true);
// const JSON_FECHA_HORA_DE_SRING_A_ARRAY_VACIO = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, []);
// const JSON_FECHA_HORA_DE_SRING_A_ARRAY_CON_DATO = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, [1]);
// const JSON_FECHA_HORA_DE_SRING_A_OBJECT = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, {});
// const JSON_FECHA_HORA_DE_SRING_A_OBJECT_CON_DATO = crearVarianteValor(JSON_MINIMO_VALIDO, PATH_FECHA_HORA_DE, { fechaHoraDespachoExterno: 1 });
...
export const registroExternoRequest = {
  ...
  "JSON_RE_DV_SRING_A_NUMBER": RE_DV_STR_A_INT,
  "JSON_RE_DV_SRING_A_STRING_CARACTER_ESPECIAL": RE_DV_STR_A_SPECIAL,
  "JSON_RE_DV_SRING_A_BOOLEAN": RE_DV_STR_A_BOOL,
  "JSON_RE_DV_SRING_A_ARRAY_VACIO": RE_DV_STR_A_ARR_EMPTY,
  "JSON_RE_DV_SRING_A_ARRAY_CON_DATO": RE_DV_STR_A_ARR_DATA,
  "JSON_RE_DV_SRING_A_OBJECT": RE_DV_STR_A_OBJ_EMPTY,
  "JSON_RE_DV_SRING_A_OBJECT_CON_DATO": RE_DV_STR_A_OBJ_DATA,
  ...
  "JSON_RE_FECHA_HORA_DE_SRING_A_NUMBER": RE_FECHA_HORA_DE_STR_A_INT,
  "JSON_RE_FECHA_HORA_DE_SRING_A_STRING_CARACTER_ESPECIAL": RE_FECHA_HORA_DE_STR_A_SPECIAL,
  "JSON_RE_FECHA_HORA_DE_SRING_A_BOOLEAN": RE_FECHA_HORA_DE_STR_A_BOOL,
  "JSON_RE_FECHA_HORA_DE_SRING_A_ARRAY_VACIO": RE_FECHA_HORA_DE_STR_A_ARR_EMPTY,
  "JSON_RE_FECHA_HORA_DE_SRING_A_ARRAY_CON_DATO": RE_FECHA_HORA_DE_STR_A_ARR_DATA,
  "JSON_RE_FECHA_HORA_DE_SRING_A_OBJECT": RE_FECHA_HORA_DE_STR_A_OBJ_EMPTY,
  "JSON_RE_FECHA_HORA_DE_SRING_A_OBJECT_CON_DATO": RE_FECHA_HORA_DE_STR_A_OBJ_DATA,
  ...
  "JSON_RI_DV_SRING_A_NUMBER": RI_DV_STR_A_INT,
  "JSON_RI_DV_SRING_A_STRING_CARACTER_ESPECIAL": RI_DV_STR_A_SPECIAL,
  "JSON_RI_DV_SRING_A_BOOLEAN": RI_DV_STR_A_BOOL,
  "JSON_RI_DV_SRING_A_ARRAY_VACIO": RI_DV_STR_A_ARR_EMPTY,
  "JSON_RI_DV_SRING_A_ARRAY_CON_DATO": RI_DV_STR_A_ARR_DATA,
  "JSON_RI_DV_SRING_A_OBJECT": RI_DV_STR_A_OBJ_EMPTY,
  "JSON_RI_DV_SRING_A_OBJECT_CON_DATO": RI_DV_STR_A_OBJ_DATA,
  ...
  "JSON_RI_FECHA_HORA_DE_SRING_A_NUMBER": RI_FECHA_HORA_DE_STR_A_INT,
  "JSON_RI_FECHA_HORA_DE_SRING_A_STRING_CARACTER_ESPECIAL": RI_FECHA_HORA_DE_STR_A_SPECIAL,
  "JSON_RI_FECHA_HORA_DE_SRING_A_BOOLEAN": RI_FECHA_HORA_DE_STR_A_BOOL,
  "JSON_RI_FECHA_HORA_DE_SRING_A_ARRAY_VACIO": RI_FECHA_HORA_DE_STR_A_ARR_EMPTY,
  "JSON_RI_FECHA_HORA_DE_SRING_A_ARRAY_CON_DATO": RI_FECHA_HORA_DE_STR_A_ARR_DATA,
  "JSON_RI_FECHA_HORA_DE_SRING_A_OBJECT": RI_FECHA_HORA_DE_STR_A_OBJ_EMPTY,
  "JSON_RI_FECHA_HORA_DE_SRING_A_OBJECT_CON_DATO": RI_FECHA_HORA_DE_STR_A_OBJ_DATA,
