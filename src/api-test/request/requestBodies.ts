...
const JSON_NOTIFICACION_SIN_CONFIGURACION_DESTINATARIOS = crearVarianteSinCampo(
  JSON_NOTIFICACION_VALIDO,
  'configuracionDestinatarios'
);
const JSON_NOTIFICACION_SIN_USUARIO_SOLICITANTE = crearVarianteSinCampo(
  JSON_NOTIFICACION_VALIDO,
  'usuarioSolicitante'
);
const JSON_NOTIFICACION_SIN_RUN_USUARIO_SOLICITANTE = crearVarianteSinCampo(
  JSON_NOTIFICACION_VALIDO,
  'usuarioSolicitante.run'
);
const JSON_NOTIFICACION_SIN_DV_USUARIO_SOLICITANTE = crearVarianteSinCampo(
  JSON_NOTIFICACION_VALIDO,
  'usuarioSolicitante.dv'
);
const JSON_NOTIFICACION_SIN_TIPO_PROCEDIMIENTO = crearVarianteSinCampo(
  JSON_NOTIFICACION_VALIDO,
  'tipoProcedimientoAdministrativo'
);
const JSON_NOTIFICACION_DESTINATARIO_NO_DEPENDIENTE = crearVarianteValor(
  JSON_NOTIFICACION_VALIDO,
  'configuracionDestinatarios.destinatarios.0.entidadDestinatariaCodificadorId',
...
export const comunicacionRequest = {
  ...
  "JSON_NOTIFICACION_SIN_CONFIGURACION_DESTINATARIOS": JSON_NOTIFICACION_SIN_CONFIGURACION_DESTINATARIOS,
  "JSON_NOTIFICACION_SIN_USUARIO_SOLICITANTE": JSON_NOTIFICACION_SIN_USUARIO_SOLICITANTE,
  "JSON_NOTIFICACION_SIN_RUN_USUARIO_SOLICITANTE": JSON_NOTIFICACION_SIN_RUN_USUARIO_SOLICITANTE,
  "JSON_NOTIFICACION_SIN_DV_USUARIO_SOLICITANTE": JSON_NOTIFICACION_SIN_DV_USUARIO_SOLICITANTE,
  "JSON_NOTIFICACION_SIN_TIPO_PROCEDIMIENTO": JSON_NOTIFICACION_SIN_TIPO_PROCEDIMIENTO,
  "JSON_NOTIFICACION_DESTINATARIO_NO_DEPENDIENTE": JSON_NOTIFICACION_DESTINATARIO_NO_DEPENDIENTE,
