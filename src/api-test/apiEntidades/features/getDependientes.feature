...
# =================================================================================
  ...
  Scenario: Enviar petición "GET" - "/entidades/dependientes/:entidadCodificadorId" con datos válidos
    Given que realizo una petición "GET" a "/entidades/dependientes/598" con token "válido"
  ...
  Scenario Outline: Validar "GET" - "/entidades/dependientes/:entidadCodificadorId" con distintos token
    Given que realizo una petición "GET" a "/entidades/dependientes/598" con token "<tipo_auth>"
  ...
  Scenario Outline: Validar "GET" - "/entidades/dependientes/:entidadCodificadorId" campo id con distintos tipos de datos
    Given que realizo una petición "GET" a "/entidades/dependientes/<tipo_dato>" con token "válido"
    Then el estado de la respuesta debe ser <status>
    And el cuerpo de la respuesta debe tener la estructura de error "<estructura>"
