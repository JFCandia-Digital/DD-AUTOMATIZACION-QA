@API @Entidades @GetIdentificadoresByCodificadorIds
Feature: Pruebas realizadas a la API "GET" - "/entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=XXXX"
# =========================================================================================================
# == Pruebas para método GET /entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=XXXX
# =========================================================================================================

  Scenario: Enviar petición "GET" - "/entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=XXXX" con datos válidos
    Given que realizo una petición "GET" a "/entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=598" con token "válido"
  ...
  Scenario Outline: Validar "GET" - "/entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=XXXX" con distintos token
    Given que realizo una petición "GET" a "/entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=598" con token "<tipo_auth>"
  ...
  Scenario Outline: Validar "GET" - "/entidades/identificadores-by-codificador-ids?id%20EntidadCodificador=XXXX" campo id con distintos tipos de datos
