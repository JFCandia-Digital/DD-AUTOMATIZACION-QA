...
# =================================================================================
  ...
  Scenario Outline: Validar "GET" - "/entidades/id-by-codificador-id/:entidadCodificadorId" campo id con distintos tipos de datos
    Given que realizo una petición "GET" a "/entidades/id-by-codificador-id/<tipo_dato>" con token "válido"
    Then el estado de la respuesta debe ser <status>
    And el cuerpo de la respuesta debe tener la estructura de error "<estructura>"
